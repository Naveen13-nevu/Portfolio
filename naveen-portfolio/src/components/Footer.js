    ...
    <footer className="footer">
      <div className="footer-inner container">
        ...
        <div className="footer-right">
          <a href="https://www.linkedin.com/in/naveen1313" target="_blank" rel="noreferrer" className="footer-icon" title="LinkedIn">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
              <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/>
              <circle cx="4" cy="4" r="2"/>
            </svg>
          </a>
          <a href="https://github.com/Naveen13-nevu" target="_blank" rel="noreferrer" className="footer-icon" title="GitHub">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
