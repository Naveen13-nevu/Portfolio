            ...
            <div className="cl-card">
              ...
              <div className="social-links">
                ...
                <div className="sl-buttons">
                  <a href="https://www.linkedin.com/in/naveen1313/" target="_blank" rel="noreferrer" className="sl-btn">
                  ...
                  <a href="https://github.com/Naveen13-nevu" target="_blank" rel="noreferrer" className="sl-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
